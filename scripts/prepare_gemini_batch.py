...
def build_prompt_json(job_description: str, candidates: List[Dict[str, Any]], rank_n: int = 50, explain_n: int = 20) -> str:
    ...
    instructions = [
        ...
        f"Return exactly top{rank_n} candidates, unique cand_id values, and STOP after closing the JSON object.",
        "",
        ...
        f"- For ranks below top {explain_n}, reasons MUST be [] and missing_requirements MUST be [].",
        "- Keep each bullet very short (max ~12 words).",
        "",
        "INPUT_JSON:",
